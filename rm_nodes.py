...
@author Chen Wang
@date 12/2014
Remove nodes denoted in the file from current slice
"""
import sys
import xmlrpclib
import sets
...
if len(sys.argv) < 4:
    print "Usage: python rm_nodes.py planetlab_user_name planetlab_password planetlab_slice_name nodes_todel_file"
    sys.exit(-1)
